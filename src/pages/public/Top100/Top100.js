...
import bgtop100 from "../../../assets/bg-top100.png";
      ...
      {data ? (
        <div className={cx("container")}>
          <div className={cx("wrapper_chart")}>
            <img src={bgtop100} alt="bg_chart" className={cx("bg_chart")} />
            ...
            <div className={cx("chart_title")}>
              ...
              <div>
                {data &&
                  data
                    ?.filter((item, index) => item?.sectionType === "playlist")
                    ?.map((item, index) => (
                      <Section
                        data={item}
                        isCheckStylePadding={true}
                        isCheckSeeAll={true}
                      />
                    ))}
              </div>
